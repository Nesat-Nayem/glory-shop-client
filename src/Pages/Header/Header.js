  ...
  return (
    <div>
      ...
      <div className="top-header">
        <p className="Special-offers-top">
          Special Offers! - <span style={{ color: "#F4C340" }}>Get 50%</span>
          off on Vegitables
        </p>
      ...
      <Navbar bg="" expand="lg" className=" px-1 main-navbar">
        <Navbar.Brand as={NavLink} to="/" className="grid-logo">
          <img
            className="hfe-site-logo-img elementor-animation- lazyloaded"
            src="https://demo2wpopal.b-cdn.net/ecolive/wp-content/uploads/2021/10/logo.svg"
            alt="logo"
        ...
        <form action="" className="mx-auto search-form grid-search-form">
          <div className="input-group border p-1">
            <input
              ...
              className="form-control bg-none border-0 bg-transparent"
            />
        ...
        <Navbar.Toggle
          ...
          className="grid-menu border-0 outline-0"
        />
          ...
          <Nav className="mx-auto navs">
                ...
                {user?.displayName ? (
                  ...
                  <>
                    <div className="d-inline-block p-0">
                      <button
                        type="button"
                        className=" p-0 bg-transparent border-0 text-black dropdown-toggle"
                      ...
                      <div
                        ...
                        className="dropdown-menu border-0 bg-transparent dropdown-menu-lg-end p-0"
                        style={{
                          position: "absolute",
                          top: "3.5rem",
                          right: 0,
            ...
            <Nav.Item className="mx-2 d-flex justify-content-center align-items-center">
              <button
                ...
                onClick={toggleDrawerWishlist("right", true)}
              >
